...
from theorielearn.scaffolded_writing.student_submission import (
    AmbiguousParseException,
    PathCanNeverExistWarning,
    StudentSubmission,
)
...
class VerifyStudentSubmission:
    ...
    def verify_exception_on_checks_that_always_return_false(
        self, path: List[str]
    ) -> None:
