...
def assert_fsm_json_exception_contains(
    ...
    *,
    ...
    with pytest.raises(ju.JsonValidationError) as err:
...
def verify_exception_empty_state_name() -> None:
    fsm_json: ju.FSMRawJsonDict = {
...
def verify_exception_duplicate_states() -> None:
    fsm_json: ju.FSMRawJsonDict = {
        "input_symbols": INPUT_SYMBOLS,
        "epsilon_symbol": EPSILON_SYMBOL,
        "states": ["q1", "q1"],
...
def verify_exception_multiple_start_states() -> None:
    fsm_json: ju.FSMRawJsonDict = {
        "input_symbols": INPUT_SYMBOLS,
        "epsilon_symbol": EPSILON_SYMBOL,
        "states": ["q1", "q2"],
...
def verify_exception_no_final_state() -> None:
    fsm_json: ju.FSMRawJsonDict = {
        "input_symbols": INPUT_SYMBOLS,
        "epsilon_symbol": EPSILON_SYMBOL,
        "states": ["q1"],
...
def verify_exception_duplicate_transitions() -> None:
    fsm_json: ju.FSMRawJsonDict = {
        "input_symbols": INPUT_SYMBOLS,
        "epsilon_symbol": EPSILON_SYMBOL,
        "states": ["q1"],
...
def verify_exception_missing_transitions() -> None:
    fsm_json: ju.FSMRawJsonDict = {
        "input_symbols": INPUT_SYMBOLS,
        "epsilon_symbol": EPSILON_SYMBOL,
        "states": ["q1", "q2"],
...
def verify_exception_invalid_character() -> None:
    fsm_json: ju.FSMRawJsonDict = {
        "input_symbols": INPUT_SYMBOLS,
        "epsilon_symbol": EPSILON_SYMBOL,
        "states": ["q1", "q2"],
...
def verify_exception_blank_character() -> None:
...
def verify_exception_unreachable_states() -> None:
    fsm_json: ju.FSMRawJsonDict = {
        "input_symbols": INPUT_SYMBOLS,
        "epsilon_symbol": EPSILON_SYMBOL,
        "states": ["q1", "q2"],
...
def verify_exception_unreachable_states_dump_state() -> None:
    fsm_json: ju.FSMRawJsonDict = {
        "input_symbols": INPUT_SYMBOLS,
        "epsilon_symbol": EPSILON_SYMBOL,
        "states": ["q1", "q2"],
...
def verify_dfa_exception_duplicate_character_transitions() -> None:
    fsm_json: ju.FSMRawJsonDict = {
        "input_symbols": INPUT_SYMBOLS,
        "epsilon_symbol": EPSILON_SYMBOL,
        "states": ["q1", "q2"],
...
def verify_dfa_no_exception_redundant_dump_state() -> None:
    ...
    ju.dfa_convert_json(dfa_json, dump_state=True)
