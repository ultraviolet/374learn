...
def generate(data: Dict[str, Any]) -> None:
    ...
    data["params"]["description"] = (
        "Instead of following Thompson's algorithm, the student decides to put an $\\varepsilon$-transition "
        "from the accepting state $e$ to the start state $a$ in order create the loop. "
