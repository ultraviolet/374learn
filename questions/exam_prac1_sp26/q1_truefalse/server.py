...
(c) Yes — a DFA can track the difference m-n, accepting once it is ≤ 374; this is regular.
(d) No — counterexample: L = {a^p | p is prime}; L* is also non-regular.
...
(h) No — the empty language ∅ is regular and accepted by a DFA with 0 accepting states.
