...
from theorielearn.pseudocode_order_blocks.utils import (
    extract_submitted_pseudocode,
    submit_translated_code,
)
...
def parse(data: Dict[str, Dict[str, Any]]) -> None:
    ...
    if pseudocode is None:
        ...
        submit_translated_code(
            data, pseudocode, mapping, imports, function_line, setup_lines, return_line
        )
